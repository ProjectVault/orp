...
DEFHEADING(ORP options:)
STEXI
@table @option
ETEXI

DEF("ffs", HAS_ARG, QEMU_OPTION_ffs,
    "-ffs rfile=portnum\n"
    "                listen on the specified port number for rfile connections\n"
    "-ffs wfile=portnum\n"
    "                listen on the specified port number for wfile connections\n"
    "-ffs host_ip=id_address\n"
    "                bind to the specified IP address for the faux filesystem\n",
    QEMU_ARCH_OPENRISC)
STEXI
@item -ffs rfile=@var{portnum}
@findex -ffs
listen on the specified port number for rfile connections

@item -ffs wfile=@var{portnum}
listen on the specified port number for wfile connections

@item -ffs host_ip=@var{ip_address}
bind to the specified IP address for the faux filesystem
ETEXI
